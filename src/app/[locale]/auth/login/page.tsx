...
export async function generateMetadata({
	...
	const titles = {
		zh: "登录 - TokenFaucet",
		en: "Sign In - TokenFaucet",
	};
	const descriptions = {
		zh: "登录您的账户以继续使用 TokenFaucet 服务",
		en: "Sign in to continue using TokenFaucet services",
	};
	return {
		title: titles[locale],
...
const texts = {
	zh: {
		title: "欢迎回来",
		subtitle: "登录您的账户继续使用 TokenFaucet 服务",
		brandName: "TokenFaucet",
		tagline: "让 AI 成为你的超能力",
		description:
	...
	en: {
		title: "Welcome Back",
		subtitle: "Sign in to continue using TokenFaucet",
		brandName: "TokenFaucet",
		tagline: "Make AI Your Superpower",
		description:
					...
					<div className="max-w-lg space-y-12">
						...
						<div className="space-y-5">
							<div className="flex items-start gap-4 group">
								<div className="w-10 h-10 rounded-xl bg-amber-50 border border-amber-200/60 flex items-center justify-center shrink-0 group-hover:bg-amber-100 group-hover:border-amber-300/60 transition-colors duration-300">
									<svg
							...
							<div className="flex items-start gap-4 group">
								<div className="w-10 h-10 rounded-xl bg-orange-50 border border-orange-200/60 flex items-center justify-center shrink-0 group-hover:bg-orange-100 group-hover:border-orange-300/60 transition-colors duration-300">
									<svg
							...
							<div className="flex items-start gap-4 group">
								<div className="w-10 h-10 rounded-xl bg-yellow-50 border border-yellow-200/60 flex items-center justify-center shrink-0 group-hover:bg-yellow-100 group-hover:border-yellow-300/60 transition-colors duration-300">
									<svg
